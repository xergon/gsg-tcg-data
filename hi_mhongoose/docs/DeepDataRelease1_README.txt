           Brief explanation of the contents of the 1st Deep Data Releases

           Deep Data Release 1 consists of the full-depth data of the following 10 MHONGOOSE
           galaxies: J0309-41, J0419-54, J1106-14, J1153-28, J1253-12, J1254-10a, J1303-17b,
           J1318-21, J1321-31, J1337-28.
...
     We include cubes at various resolutions, covering the HI resolution range available to
     ...
     (see     ready Cubes
        now the                  section
                    to be combined     and for above).
                                               the full-depthThe     mostto important details are that we used the S+C
                                                               data cubes
       nder
     ...
     large      majority
        large range  in angularofresolution
                                    cases(Fig.the        detected
     ...
     In low-column
         terms
        this  wealthof
                      density features (Fig. 2). It is difficult to capture
                     of kernels
     ...
     Moment
       ...
       overview of the H i to morphology                                    Fig. 5. Sensitivities of the full-depth data cubes. The top panel shows the
     corresponding                 each and  of kinematics
                                                 the standardof the sample
                                                                       resolutions.
