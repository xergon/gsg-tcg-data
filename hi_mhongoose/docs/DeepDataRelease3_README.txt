           Brief explanation of the contents of the 3rd Deep Data Releases

           Deep Data Release 3 consists of the full-depth data of the following 11 MHONGOOSE
           galaxies: J0008-34, J0031-22, J0049-20, J0052-31, J0310-39, J0320-52, J0331-51,
           J0351-38, J0445-59, J0454-53, J0516-37
...
     We include cubes at various resolutions, covering the HI resolution range available to
     ...
     reliability
        of compact,noise      distribution,
                      high-column                soasthat
                                   density sources,            the
                                                         well as       value of minSNR was the only relevant parameter.
                                                                  extended,
     In low-column
         terms     of density features (Fig. 2). It is difficult to capture
                        kernels     we    found      that    using
        this wealth of structure in a single data cube at a single reso-larger spatial kernels than used here led to over-
     smoothing
        lution. For and
                    MHONGOOSE,the weaddition
                                         have of       noise
                                               therefore  definedinsixthe   moment maps (i.e., MeerKAT is very e cient at
                                                                        stan-
        dard resolutions for our data products, which cover the angular
     picking      up     HI   emission        and      large
        resolution range of MeerKAT as indicated in Fig. 2.
                                                                  smoothing       factors give diminishing returns). More
     ...
     Moment
       ...
       overview   of the H i tomorphology    and the
                                                 kinematics of  the sample   Fig. 5. Sensitivities of the full-depth data cubes. The top panel shows the
     corresponding                 each of              standard       resolutions.
                                                                                             ...
                                                                                             full-depth            the
                                                                                                         observations  of number
                                                                                                                           ten galaxies   of
                                                                                                                                        (cf.   channels
                                                                                                                                             Fig.
                                                                             bars show the rms di↵erence in noise levels between the ten galax-
                                                                                                                                                  1). Error
       beam size as derived
     contributing         to   afrom  the full-depth standard
                                   moment-map             pixelcubes of ten ies, butaaretwo
                                                                   (*chan*),                     dimensional
                                                                                          generally    comparable to or mask         identifying
                                                                                                                          smaller than   the symbol size.the
     ...
     detected
       umn   densitysources        (*mask-2d*)
                     sensitivities where we              andfora1 over a
                                              give the values      (compressed)
                                                                             These are the3D     maskas that
                                                                                            same points              was
                                                                                                              shown in  Fig. 2.used to create the
       single channel, as well as the 3 over 16 km s 1 values used in
     moment        maps       (*mask.fits.gz;                except     for
       Fig. 2. Finally, we also list the 3 H i mass detection limit for an
                                                                            r00_t00).             In   addition        a  zeroth-moment map
     which     hassource,
       unresolved      been       primary-beam
                             assuming a                   corrected
                                          distance of 10 Mpc (the   medianis also provided (*mom0_pb*) as well as the
       ...
       50 km s 1 .                                                           upturn in the noise curve at large resolutions in Fig. 1 and the
           The highest resolution of ⇠800 is achieved using a robustness top panel in Fig. 5.
       parameter of zero. Decreasing the robustness parameter even fur-
       ther to negative values resulted in too small a decrease of the
                                                                             5.7. Creating the full-depth cubes
       beam size to justify the loss of sensitivity. This loss is due to
       the relatively small number of longest baselines (cf. Table 3). For the full-depth observations, we combine the ten individual
                      fi
fi
fl                                                    fi              fi           ff                                                ffi
