...
if(mystep in thesteps):
  ...
  if os.path.exists('uid___A002_X91068d_Xc50.ms') == False:
    importasdm('uid___A002_X91068d_Xc50', asis='Antenna Station Receiver Source CalAtmosphere CalWVR')
  if applyonly != True: es.fixForCSV2555('uid___A002_X91068d_Xc50.ms')
...
if(mystep in thesteps):
  ...
  fixsyscaltimes(vis = 'uid___A002_X91068d_Xc50.ms')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.listobs')
  listobs(vis = 'uid___A002_X91068d_Xc50.ms',
    listfile = 'uid___A002_X91068d_Xc50.ms.listobs')
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_X91068d_Xc50.ms',
    mode = 'manual',
    spw = '1~21',
    autocorr = T,
    flagbackup = F)
  ...
  flagcmd(vis = 'uid___A002_X91068d_Xc50.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_X91068d_Xc50.ms.flagcmd.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.wvr') 
  
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.wvrgcal') 
  
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_X91068d_Xc50.ms.wvrgcal')
  
  wvrgcal(vis = 'uid___A002_X91068d_Xc50.ms',
    caltable = 'uid___A002_X91068d_Xc50.ms.wvr',
    toffset = 0,
  ...
  tb.open('uid___A002_X91068d_Xc50.ms.wvr', nomodify=False)
  count = 0
  numrows = tb.nrows()
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.wvr.smooth') 
  
  smoothcal(vis = 'uid___A002_X91068d_Xc50.ms',
    tablein = 'uid___A002_X91068d_Xc50.ms.wvr',
    caltable = 'uid___A002_X91068d_Xc50.ms.wvr.smooth',
    smoothtype = 'mean',
    smoothtime = 6.048)
  
  
  if applyonly != True: aU.plotWVRSolutions(caltable='uid___A002_X91068d_Xc50.ms.wvr.smooth', spw='11', antenna='DA56',
    yrange=[-199,199],subplot=22, interactive=False,
    figfile='uid___A002_X91068d_Xc50.ms.wvr.smooth.plots/uid___A002_X91068d_Xc50.ms.wvr.smooth') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.tsys') 
  gencal(vis = 'uid___A002_X91068d_Xc50.ms',
    caltable = 'uid___A002_X91068d_Xc50.ms.tsys',
    caltype = 'tsys')
  
  if applyonly != True: aU.plotbandpass(caltable='uid___A002_X91068d_Xc50.ms.tsys', overlay='time', 
    xaxis='freq', yaxis='amp', subplot=22, buildpdf=False, interactive=False,
    showatm=True,pwv='auto',chanrange='5~123',showfdm=True, 
    field='', figfile='uid___A002_X91068d_Xc50.ms.tsys.plots.overlayTime/uid___A002_X91068d_Xc50.ms.tsys') 
  
  
  if applyonly != True: es.checkCalTable('uid___A002_X91068d_Xc50.ms.tsys', msName='uid___A002_X91068d_Xc50.ms', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.antpos') 
  gencal(vis = 'uid___A002_X91068d_Xc50.ms',
    caltable = 'uid___A002_X91068d_Xc50.ms.antpos',
    caltype = 'antpos',
...
if(mystep in thesteps):
  ...
  tsysmap = tsysspwmap(vis = 'uid___A002_X91068d_Xc50.ms', tsystable = 'uid___A002_X91068d_Xc50.ms.tsys', tsysChanTol = 1)
  
  
  
  applycal(vis = 'uid___A002_X91068d_Xc50.ms',
    field = '0',
    spw = '11,13,15,17',
    gaintable = ['uid___A002_X91068d_Xc50.ms.tsys', 'uid___A002_X91068d_Xc50.ms.wvr.smooth', 'uid___A002_X91068d_Xc50.ms.antpos'],
    gainfield = ['0', '', ''],
  ...
  if applyonly != True: es.getCalWeightStats('uid___A002_X91068d_Xc50.ms') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split') 
  split(vis = 'uid___A002_X91068d_Xc50.ms',
    outputvis = 'uid___A002_X91068d_Xc50.ms.split',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.listobs')
  listobs(vis = 'uid___A002_X91068d_Xc50.ms.split',
    listfile = 'uid___A002_X91068d_Xc50.ms.split.listobs')
  
  tb.open('uid___A002_X91068d_Xc50.ms.split/POINTING', nomodify = False)
  a = tb.rownumbers()
  tb.removerows(a)
  tb.close()
  
  if not os.path.exists('uid___A002_X91068d_Xc50.ms.split.flagversions/Original.flags'):
    flagmanager(vis = 'uid___A002_X91068d_Xc50.ms.split',
      mode = 'save',
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_X91068d_Xc50.ms.split',
    mode = 'shadow',
    flagbackup = F)
...
if(mystep in thesteps):
  ...
  # au.getALMAFluxForMS('uid___A002_X91068d_Xc50.ms.split',field='1',frequency='144.565804758GHz')
  setjy('uid___A002_X91068d_Xc50.ms.split',
        standard='manual', field='J0854+2006', spix=-0.369567,
        reffreq='144.565805GHz', fluxdensity=[4.213257,0,0,0])

"""
  setjy(vis = 'uid___A002_X91068d_Xc50.ms.split',
    field = '1', # source name = J0854+2006
    spw = '0', # center frequency of spw = 144.565804758GHz
    standard = 'manual',
  ...
  setjy(vis = 'uid___A002_X91068d_Xc50.ms.split',
    field = '1', # source name = J0854+2006
    spw = '1', # center frequency of spw = 154.710825314GHz
    standard = 'manual',
  ...
  setjy(vis = 'uid___A002_X91068d_Xc50.ms.split',
    field = '1', # source name = J0854+2006
    spw = '2', # center frequency of spw = 156.443586558GHz
    standard = 'manual',
  ...
  setjy(vis = 'uid___A002_X91068d_Xc50.ms.split',
    field = '1', # source name = J0854+2006
    spw = '3', # center frequency of spw = 142.648804758GHz
    standard = 'manual',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.ap_pre_bandpass') 
  
  gaincal(vis = 'uid___A002_X91068d_Xc50.ms.split',
    caltable = 'uid___A002_X91068d_Xc50.ms.split.ap_pre_bandpass',
    field = '0', # J0825+0309
  ...
  if applyonly != True: es.checkCalTable('uid___A002_X91068d_Xc50.ms.split.ap_pre_bandpass', msName='uid___A002_X91068d_Xc50.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.bandpass') 
  bandpass(vis = 'uid___A002_X91068d_Xc50.ms.split',
    caltable = 'uid___A002_X91068d_Xc50.ms.split.bandpass',
    field = '', # J0825+0309
    intent = '*BANDPASS*',
    solint = 'inf,15.6MHz',
    combine = 'scan',
    ...
    solnorm = True,
    bandtype = 'B',
    gaintable = 'uid___A002_X91068d_Xc50.ms.split.ap_pre_bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_X91068d_Xc50.ms.split.bandpass', msName='uid___A002_X91068d_Xc50.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.phase_int') 
  gaincal(vis = 'uid___A002_X91068d_Xc50.ms.split',
    caltable = 'uid___A002_X91068d_Xc50.ms.split.phase_int',
    field = '0~2', # J0825+0309,J0854+2006,J0909+0121
    solint = 'int',
    refant = 'DA56',
    gaintype = 'G',
    calmode = 'p',
    gaintable = 'uid___A002_X91068d_Xc50.ms.split.bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_X91068d_Xc50.ms.split.phase_int', msName='uid___A002_X91068d_Xc50.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.ampli_inf') 
  gaincal(vis = 'uid___A002_X91068d_Xc50.ms.split',
    caltable = 'uid___A002_X91068d_Xc50.ms.split.ampli_inf',
    field = '0~2', # J0825+0309,J0854+2006,J0909+0121
    solint = 'inf',
    refant = 'DA56',
    gaintype = 'T',
    calmode = 'a',
    gaintable = ['uid___A002_X91068d_Xc50.ms.split.bandpass', 'uid___A002_X91068d_Xc50.ms.split.phase_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_X91068d_Xc50.ms.split.ampli_inf', msName='uid___A002_X91068d_Xc50.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.flux_inf') 
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.fluxscale') 
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_X91068d_Xc50.ms.split.fluxscale')
  
  fluxscaleDict = fluxscale(vis = 'uid___A002_X91068d_Xc50.ms.split',
    caltable = 'uid___A002_X91068d_Xc50.ms.split.ampli_inf',
    fluxtable = 'uid___A002_X91068d_Xc50.ms.split.flux_inf',
    reference = '1') # J0854+2006
  
  casalog.setlogfile(mylogfile)
  
  if applyonly != True: es.fluxscale2(caltable = 'uid___A002_X91068d_Xc50.ms.split.ampli_inf', removeOutliers=True, msName='uid___A002_X91068d_Xc50.ms', writeToFile=True, preavg=10000)
  
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.phase_inf') 
  gaincal(vis = 'uid___A002_X91068d_Xc50.ms.split',
    caltable = 'uid___A002_X91068d_Xc50.ms.split.phase_inf',
    field = '0~2', # J0825+0309,J0854+2006,J0909+0121
    solint = 'inf',
    refant = 'DA56',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_X91068d_Xc50.ms.split.phase_inf', msName='uid___A002_X91068d_Xc50.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  for i in ['0', '1']: # J0825+0309,J0854+2006
    applycal(vis = 'uid___A002_X91068d_Xc50.ms.split',
      field = str(i),
      gaintable = ['uid___A002_X91068d_Xc50.ms.split.bandpass', 'uid___A002_X91068d_Xc50.ms.split.phase_int', 'uid___A002_X91068d_Xc50.ms.split.flux_inf'],
      gainfield = ['', i, i],
      interp = 'linear,linear',
      calwt = F,
      flagbackup = F)
  ...
  applycal(vis = 'uid___A002_X91068d_Xc50.ms.split',
    field = '2,3', # SDP.81
    gaintable = ['uid___A002_X91068d_Xc50.ms.split.bandpass', 'uid___A002_X91068d_Xc50.ms.split.phase_inf', 'uid___A002_X91068d_Xc50.ms.split.flux_inf'],
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.cal') 
  split(vis = 'uid___A002_X91068d_Xc50.ms.split',
    outputvis = 'uid___A002_X91068d_Xc50.ms.split.cal',
    datacolumn = 'corrected',
    keepflags = T)

  # Additional flags
  flagdata(vis='uid___A002_X91068d_Xc50.ms.split.cal',
           mode='manual',
           spw='',
           antenna='DV06')
  flagdata(vis='uid___A002_X91068d_Xc50.ms.split.cal',
  ...
  # High/low amp values on calibrator for this scan
  flagdata(vis='uid___A002_X91068d_Xc50.ms.split.cal',
           mode='manual',
           spw='',
           scan='26',
  ...
  os.system('rm -rf uid___A002_X91068d_Xc50.ms.split.cal.science') 
  split(vis = 'uid___A002_X91068d_Xc50.ms.split.cal',
    outputvis = 'uid___A002_X91068d_Xc50.ms.split.cal.science',
    datacolumn = 'data',
