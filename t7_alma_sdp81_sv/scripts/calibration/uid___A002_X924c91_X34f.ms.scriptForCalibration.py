...
# DV14: low amp gain solns on spw2
# DV04: low amp gain solns on all spws, for first quarter of execution
# PM04: spw 2 has high amps when plotting visibilities averaged in time
...
if(mystep in thesteps):
  ...
  if os.path.exists('uid___A002_X924c91_X34f.ms') == False:
    importasdm('uid___A002_X924c91_X34f', asis='Antenna Station Receiver Source CalAtmosphere CalWVR')
  if applyonly != True: es.fixForCSV2555('uid___A002_X924c91_X34f.ms')
...
if(mystep in thesteps):
  ...
  fixsyscaltimes(vis = 'uid___A002_X924c91_X34f.ms')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.listobs')
  listobs(vis = 'uid___A002_X924c91_X34f.ms',
    listfile = 'uid___A002_X924c91_X34f.ms.listobs')
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_X924c91_X34f.ms',
    mode = 'manual',
    spw = '1~21',
    autocorr = T,
    flagbackup = F)
  ...
  flagcmd(vis = 'uid___A002_X924c91_X34f.ms',
    inpmode = 'table',
    useapplied = True,
    action = 'plot',
    plotfile = 'uid___A002_X924c91_X34f.ms.flagcmd.png')
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.wvr') 
  
  os.system('rm -rf uid___A002_X924c91_X34f.ms.wvrgcal') 
  
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_X924c91_X34f.ms.wvrgcal')
  
  wvrgcal(vis = 'uid___A002_X924c91_X34f.ms',
    caltable = 'uid___A002_X924c91_X34f.ms.wvr',
    toffset = 0,
  ...
  tb.open('uid___A002_X924c91_X34f.ms.wvr', nomodify=False)
  count = 0
  numrows = tb.nrows()
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.wvr.smooth') 
  
  smoothcal(vis = 'uid___A002_X924c91_X34f.ms',
    tablein = 'uid___A002_X924c91_X34f.ms.wvr',
    caltable = 'uid___A002_X924c91_X34f.ms.wvr.smooth',
    smoothtype = 'mean',
    smoothtime = 2.016)
  
  
  if applyonly != True: aU.plotWVRSolutions(caltable='uid___A002_X924c91_X34f.ms.wvr.smooth', spw='11', antenna='DA56',
    yrange=[-199,199],subplot=22, interactive=False,
    figfile='uid___A002_X924c91_X34f.ms.wvr.smooth.plots/uid___A002_X924c91_X34f.ms.wvr.smooth') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.tsys') 
  gencal(vis = 'uid___A002_X924c91_X34f.ms',
    caltable = 'uid___A002_X924c91_X34f.ms.tsys',
    caltype = 'tsys')
  
  if applyonly != True: aU.plotbandpass(caltable='uid___A002_X924c91_X34f.ms.tsys', overlay='time', 
    xaxis='freq', yaxis='amp', subplot=22, buildpdf=False, interactive=False,
    showatm=True,pwv='auto',chanrange='5~123',showfdm=True, 
    field='', figfile='uid___A002_X924c91_X34f.ms.tsys.plots.overlayTime/uid___A002_X924c91_X34f.ms.tsys') 
  
  
  if applyonly != True: es.checkCalTable('uid___A002_X924c91_X34f.ms.tsys', msName='uid___A002_X924c91_X34f.ms', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.antpos') 
  gencal(vis = 'uid___A002_X924c91_X34f.ms',
    caltable = 'uid___A002_X924c91_X34f.ms.antpos',
    caltype = 'antpos',
...
if(mystep in thesteps):
  ...
  tsysmap = tsysspwmap(vis = 'uid___A002_X924c91_X34f.ms', tsystable = 'uid___A002_X924c91_X34f.ms.tsys', tsysChanTol = 1)
  
  
  
  applycal(vis = 'uid___A002_X924c91_X34f.ms',
    field = '0',
    spw = '11,13,15,17',
    gaintable = ['uid___A002_X924c91_X34f.ms.tsys', 'uid___A002_X924c91_X34f.ms.wvr.smooth', 'uid___A002_X924c91_X34f.ms.antpos'],
    gainfield = ['0', '', ''],
  ...
  if applyonly != True: es.getCalWeightStats('uid___A002_X924c91_X34f.ms') 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split') 
  split(vis = 'uid___A002_X924c91_X34f.ms',
    outputvis = 'uid___A002_X924c91_X34f.ms.split',
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.listobs')
  listobs(vis = 'uid___A002_X924c91_X34f.ms.split',
    listfile = 'uid___A002_X924c91_X34f.ms.split.listobs')
  
  tb.open('uid___A002_X924c91_X34f.ms.split/POINTING', nomodify = False)
  a = tb.rownumbers()
  tb.removerows(a)
  tb.close()
  
  if not os.path.exists('uid___A002_X924c91_X34f.ms.split.flagversions/Original.flags'):
    flagmanager(vis = 'uid___A002_X924c91_X34f.ms.split',
      mode = 'save',
...
if(mystep in thesteps):
  ...
  flagdata(vis = 'uid___A002_X924c91_X34f.ms.split',
    mode = 'shadow',
    flagbackup = F)
...
if(mystep in thesteps):
  ...
  setjy('uid___A002_X924c91_X34f.ms.split',
        standard='manual', field='J0854+2006', spix=-0.369567,
        reffreq='144.566547GHz', fluxdensity=[4.213249,0,0,0])
 
"""
  setjy(vis = 'uid___A002_X924c91_X34f.ms.split',
    field = '1', # source name = J0854+2006
    spw = '0', # center frequency of spw = 144.566546839GHz
    standard = 'manual',
    fluxdensity = [5.5809311143, 0, 0, 0]) # frequency of measurement = 114.11900198GHz
  
  setjy(vis = 'uid___A002_X924c91_X34f.ms.split',
    field = '1', # source name = J0854+2006
    spw = '1', # center frequency of spw = 154.71159279GHz
    standard = 'manual',
    fluxdensity = [5.5809311143, 0, 0, 0]) # frequency of measurement = 114.11900198GHz
  
  setjy(vis = 'uid___A002_X924c91_X34f.ms.split',
    field = '1', # source name = J0854+2006
    spw = '2', # center frequency of spw = 156.444362629GHz
    standard = 'manual',
    fluxdensity = [5.5809311143, 0, 0, 0]) # frequency of measurement = 114.11900198GHz
  
  setjy(vis = 'uid___A002_X924c91_X34f.ms.split',
    field = '1', # source name = J0854+2006
    spw = '3', # center frequency of spw = 142.649546839GHz
    standard = 'manual',
    fluxdensity = [5.5809311143, 0, 0, 0]) # frequency of measurement = 114.11900198GHz
"""  
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.ap_pre_bandpass') 
  
  gaincal(vis = 'uid___A002_X924c91_X34f.ms.split',
    caltable = 'uid___A002_X924c91_X34f.ms.split.ap_pre_bandpass',
    field = '0', # J0825+0309
  ...
  if applyonly != True: es.checkCalTable('uid___A002_X924c91_X34f.ms.split.ap_pre_bandpass', msName='uid___A002_X924c91_X34f.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.bandpass') 
  bandpass(vis = 'uid___A002_X924c91_X34f.ms.split',
    caltable = 'uid___A002_X924c91_X34f.ms.split.bandpass',
    field = '', # J0825+0309
    intent = '*BANDPASS*',
    solint = 'inf,15.6MHz',
    combine = 'scan',
    ...
    solnorm = True,
    bandtype = 'B',
    gaintable = 'uid___A002_X924c91_X34f.ms.split.ap_pre_bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_X924c91_X34f.ms.split.bandpass', msName='uid___A002_X924c91_X34f.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.phase_int') 
  gaincal(vis = 'uid___A002_X924c91_X34f.ms.split',
    caltable = 'uid___A002_X924c91_X34f.ms.split.phase_int',
    field = '0~2', # J0825+0309,J0854+2006,J0909+0121
    solint = 'int',
    refant = 'DA56',
    gaintype = 'G',
    calmode = 'p',
    gaintable = 'uid___A002_X924c91_X34f.ms.split.bandpass')
  
  if applyonly != True: es.checkCalTable('uid___A002_X924c91_X34f.ms.split.phase_int', msName='uid___A002_X924c91_X34f.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.ampli_inf') 
  gaincal(vis = 'uid___A002_X924c91_X34f.ms.split',
    caltable = 'uid___A002_X924c91_X34f.ms.split.ampli_inf',
    field = '0~2', # J0825+0309,J0854+2006,J0909+0121
    solint = 'inf',
    refant = 'DA56',
    gaintype = 'T',
    calmode = 'a',
    gaintable = ['uid___A002_X924c91_X34f.ms.split.bandpass', 'uid___A002_X924c91_X34f.ms.split.phase_int'])
  
  if applyonly != True: es.checkCalTable('uid___A002_X924c91_X34f.ms.split.ampli_inf', msName='uid___A002_X924c91_X34f.ms.split', interactive=False) 
  
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.flux_inf') 
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.fluxscale') 
  mylogfile = casalog.logfile()
  casalog.setlogfile('uid___A002_X924c91_X34f.ms.split.fluxscale')
  
  fluxscaleDict = fluxscale(vis = 'uid___A002_X924c91_X34f.ms.split',
    caltable = 'uid___A002_X924c91_X34f.ms.split.ampli_inf',
    fluxtable = 'uid___A002_X924c91_X34f.ms.split.flux_inf',
    reference = '1') # J0854+2006
  
  casalog.setlogfile(mylogfile)
  
  if applyonly != True: es.fluxscale2(caltable = 'uid___A002_X924c91_X34f.ms.split.ampli_inf', removeOutliers=True, msName='uid___A002_X924c91_X34f.ms', writeToFile=True, preavg=10000)
  
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.phase_inf') 
  gaincal(vis = 'uid___A002_X924c91_X34f.ms.split',
    caltable = 'uid___A002_X924c91_X34f.ms.split.phase_inf',
    field = '0~2', # J0825+0309,J0854+2006,J0909+0121
    solint = 'inf',
    refant = 'DA56',
    gaintype = 'G',
  ...
  if applyonly != True: es.checkCalTable('uid___A002_X924c91_X34f.ms.split.phase_inf', msName='uid___A002_X924c91_X34f.ms.split', interactive=False) 
...
if(mystep in thesteps):
  ...
  for i in ['0', '1']: # J0825+0309,J0854+2006
    applycal(vis = 'uid___A002_X924c91_X34f.ms.split',
      field = str(i),
      gaintable = ['uid___A002_X924c91_X34f.ms.split.bandpass', 'uid___A002_X924c91_X34f.ms.split.phase_int', 'uid___A002_X924c91_X34f.ms.split.flux_inf'],
      gainfield = ['', i, i],
      interp = 'linear,linear',
      calwt = F,
      flagbackup = F)
  ...
  applycal(vis = 'uid___A002_X924c91_X34f.ms.split',
    field = '2,3', # SDP.81
    gaintable = ['uid___A002_X924c91_X34f.ms.split.bandpass', 'uid___A002_X924c91_X34f.ms.split.phase_inf', 'uid___A002_X924c91_X34f.ms.split.flux_inf'],
...
if(mystep in thesteps):
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.cal') 
  split(vis = 'uid___A002_X924c91_X34f.ms.split',
    outputvis = 'uid___A002_X924c91_X34f.ms.split.cal',
    datacolumn = 'corrected',
    keepflags = T)

  # Additional flags
  flagdata(vis = 'uid___A002_X924c91_X34f.ms.split.cal',
    mode = 'manual',
    antenna='PM04', spw='2',
    flagbackup = F)
  ...
  os.system('rm -rf uid___A002_X924c91_X34f.ms.split.cal.science') 
  split(vis = 'uid___A002_X924c91_X34f.ms.split.cal',
    outputvis = 'uid___A002_X924c91_X34f.ms.split.cal.science',
    datacolumn = 'data',
